...
- [ ] Fan low toggle → Ch02 (B27), active = GND (internal pull-up 10kΩ)
- [ ] Fan high toggle → Ch03 (B28), active = GND (internal pull-up 10kΩ)
- [ ] Coolsuit toggle → Ch10 (B22), active = GND (internal pull-up 10kΩ)
- [ ] Defogger toggle → Ch11 (A26), active = GND (internal pull-up 10kΩ)
...
- [ ] Warm up engine → verify fan bands activate at correct temps (25%@160°F/71°C, 50%@170°F/77°C, 75%@180°F/82°C, 100%@190°F/88°C)
