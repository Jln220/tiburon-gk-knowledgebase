...
> LLM: Read this table first for wire color and ECM pin queries. Only load the full file if you need circuit paths, component tables, or detailed context.
...
| Pin | Function | Wire Color | Wire Size | ECM Pin | V |
|-----|----------|------------|-----------|---------|---|
